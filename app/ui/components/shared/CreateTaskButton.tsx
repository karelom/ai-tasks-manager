...
export default function CreateTaskButton({ projectId, parentId }: CreateTaskProps) {
  return (
    <Link
      ...
      className="fixed bottom-18 md:bottom-8 right-8 flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition-all active:scale-95 group"
    >
